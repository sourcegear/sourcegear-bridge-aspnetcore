    ...
    aspnetcore.Microsoft.Extensions.Configuration.ConfigurationProvider
{
    ...
    public convenience init (cast h_cast: NonnullHandle) throws {
        var __thrown : NullableHandle = nil;
        let h_res = Microsoft_Extensions_Configuration_EnvironmentVariables_EnvironmentVariablesConfigurationProvider_cast(&__thrown,h_cast);
        if let __ex = __thrown {
            throw dotnet.System.Exception(hndl: __ex);
        } else {
    ...
    Microsoft_Extensions_Configuration_IConfigurationSource
{
    ...
    public convenience init (cast h_cast: NonnullHandle) throws {
        var __thrown : NullableHandle = nil;
        let h_res = Microsoft_Extensions_Configuration_EnvironmentVariables_EnvironmentVariablesConfigurationSource_cast(&__thrown,h_cast);
        if let __ex = __thrown {
            throw dotnet.System.Exception(hndl: __ex);
        } else {
            self.init(hndl: h_res);
